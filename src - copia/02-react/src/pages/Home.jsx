    ...
    <main>
      ...
      <section>
        ...
        <article>
          ...
          <p>Experimenta la nueva generacion de videojuegos con potencial sin igual</p>
        </article>

        <article>
          <img src="/switch.webp" alt="" width="200px" />
          <h4>Mouse gamer</h4>
          <p>Experimenta la nueva generación de mouse gamer con potencial sin igual</p>
        </article>
      ...
      <section>
        <article>
          <img src="/Ps5-Slim-Digital-Bundle-Ratchet-PLAYSTATION-SIN-REF-3525674_b.webp" alt="" width="200px" />
