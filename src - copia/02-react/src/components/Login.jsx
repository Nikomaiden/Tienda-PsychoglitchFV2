...
export function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Simular login (aquí después conectarás tu backend)
    setIsLoading(true);
      ...
      <div className="login-container">
        ...
        <div className="login-card">
          ...
          <div className="login-header">
            ...
            <p>Inicia sesión para continuar tu experiencia gaming</p>
          </div>
        ...
        <div className="login-footer">
          <p>Al iniciar sesión, aceptas nuestros <Link to="/terminos">Términos de Servicio</Link> y <Link to="/privacidad">Política de Privacidad</Link></p>
        </div>
      </div>
    </div>
  );
